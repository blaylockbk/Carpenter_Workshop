...
def cm_terrain(water=True, water_threshold=-99, ocean_bottom=-500, land_top=3650,
               display_cmap=False):
    """
    ...
    if water:
        ...
        nodes = [0.0, 0.8, 1.0]
        colors_ocean = mcolors.LinearSegmentedColormap.from_list("ocean_cmap", list(zip(nodes, oceancolors)))
    ...
    colors_land = mcolors.LinearSegmentedColormap.from_list("land_cmap", list(zip(nodes, landcolors)))
    ...
    if water:
        norm = MidpointNormalize(vmin=ocean_bottom,
