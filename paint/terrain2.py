...
class cm_terrain:
    ...
    """
    def __init__(self, water=True, water_threshold=-99, ocean_bottom=-500, land_top=3650):
        self.water = water
        ...
        if water:
            ...
            nodes = [0.0, 0.8, 1.0]
            colors_ocean = mcolors.LinearSegmentedColormap.from_list("ocean", list(zip(nodes, oceancolors)))
        ...
        colors_land = mcolors.LinearSegmentedColormap.from_list("land", list(zip(nodes, landcolors)))
