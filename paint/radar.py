...
def cm_reflectivity(display_cmap=False, levels=40):
    ...
    if levels is None:
        ...
        cmap = colors.LinearSegmentedColormap.from_list('NWS Reflectivity', COLORS, N=levels)
...
def cm_radialvelocity(display_cmap=False, levels=16):
    ...
    if levels is None:
        ...
        cmap = colors.LinearSegmentedColormap.from_list('NWS Radial Velocity', COLORS, N=levels)
